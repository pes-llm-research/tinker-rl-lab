...
in this repository: Tinker (managed), TRL~\citep{vonwerra2022trl} on Modal
...
launch paths in this repository. The Tinker-managed run uses Qwen3-8B-Base,
...
post-GRPO control reported in our released artifacts shows only a small,
...
reported in our released artifacts, larger groups can support different
