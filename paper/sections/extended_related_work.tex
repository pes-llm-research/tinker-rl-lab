...
group members, or (ii) the effective rank fraction (ERF) surrogate described
in the appendix (cross-reference: Appendix~\ref{sec:appendix-zvf-formalization}
in \texttt{appendix\_zvf\_formalization.tex}). Both surrogates remain
