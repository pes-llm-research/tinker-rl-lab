...
incrementally predictive statistics. Second, initialization and rollout regime
matter at least as much as algorithm labels in our short-horizon setting:
instruction-tuned checkpoints and intermediate group sizes are easier to
optimize than base models or extreme rollout groups, but the benchmark does
not justify a universal optimum or a general superiority claim for any one
