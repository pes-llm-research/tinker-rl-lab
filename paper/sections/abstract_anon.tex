...
Second, trainability depends strongly on initialization and rollout regime:
instruction-tuned checkpoints and intermediate group sizes are consistently
easier to optimize than base models or extreme group sizes in our limited
sweeps, but we do not claim a universal optimal group size. Third, PPO/GRPO
